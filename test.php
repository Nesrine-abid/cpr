...
<body>
    <div class="row">
        ...
        <div class="col-sm-2" style="margin-top:3em;">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title" style="margin-top: 1em;">Article De Substitution</h5>
        ...
        <div class="modal-content">
            ...
            <form action="" method="$_POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="AjoutArticle()">Ajouter à la commande</button>
...
<script>
    ...
    function showHint1(event) {
        ...
        if (document.getElementById(input).value.length == 0) {
            ...
            //Disponibilité
            if (array[rowNumber - 1] >= event.target.value) {
